%% find the epicenter of WM using Lp with JuSpace TC matrix in BD
path = pwd;

load('Results_epicenter_diff_TC_region_size.mat')
results_con = results;
...
%% save
cd(path)
save('Results_epicenter_diff_TC_Lp_region_size.mat','results','results_abs')