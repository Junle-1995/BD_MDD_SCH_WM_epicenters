function stepX_WM_epi_SC_T1_T2_corr_GM_diff_region_size(GM_atlas,GM_roi_num)
%% corr the GM volume diff Z map with SC T1_T2 to the WM epicenter
path = pwd;
...
%% save
cd(path)
save(['Results_WM_epicenter_SC_T1_T2_' GM_atlas '_diff_region_size.mat'],'results')
